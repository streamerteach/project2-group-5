...
import inspirational from "../assets/music/inspirational.mp3";
...
mounted() {
    ...
    localStorage.setItem("music", "hardcore");
  },
  methods: {
    ...
    audioPlay() {
        if(songChoice === "hardcore") {
            ...
            audio.play();
        } else if(songChoice === "inspirational") {
            const audio = new Audio(inspirational);
            audio.play();
